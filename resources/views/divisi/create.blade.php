...
@section('header')<h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Divisi Baru</h2>@endsection
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('divisi.store') }}" method="POST" class="space-y-4">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <button type="submit"
                                class="inline-flex items-center px-4 py-2 bg-gray-800 border rounded-md font-semibold text-xs text-white uppercase">Simpan</button>
                        </div>
                    </form>
                </div>
            </div>
