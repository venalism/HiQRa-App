                ...
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="flex space-x-2">
                            <a href="{{ route('riwayat.peserta.export', request()->query()) }}"
                    ...
                    <form method="GET" action="{{ route('riwayat.peserta') }}" class="mb-6">
                        ...
                        @if (request('kegiatan_id'))
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                {{-- Filter Prodi --}}
                                <div>
                                    <label for="prodi_id" class="block text-sm font-medium text-gray-700">Filter
                                        Prodi</label>
                                ...
                                {{-- Filter Kelas --}}
                                <div>
                                    <label for="kelas_id" class="block text-sm font-medium text-gray-700">Filter
                                        Kelas</label>
            ...
            <div id="modalContent" class="bg-white rounded-lg shadow-xl w-full max-w-lg p-6">
                ...
                <form action="{{ route('riwayat.manual.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="peserta_id" class="block text-sm font-medium text-gray-700">Pilih Panitia</label>
                            <select name="peserta_id" id="peserta_id" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('peserta_id') border-red-500 @enderror">
                                <option value="">-- Pilih Peserta --</option>
                                @foreach ($semuaPeserta as $p)
                                    <option value="{{ $p->id }}"
                                        {{ old('peserta_id') == $p->id ? 'selected' : '' }}>{{ $p->nama }}
                                        ({{ $p->npm }})
                                    </option>
                                @endforeach
                            </select>
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-lg p-6">
            ...
            <form id="editForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="edit_keterangan" class="block text-sm font-medium text-gray-700">Keterangan
                            (Opsional)</label>
