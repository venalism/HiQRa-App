    ...
    <div class="animate-fadeIn">
        ...
        @if(Auth::user()->role === 'admin')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-8">
                ...
                <div class="bg-white rounded-lg shadow-md p-4 text-center">
                    <div class="text-2xl font-bold text-gray-800">{{ $belumHadir }}</div>
                    <div class="text-sm text-gray-600">Belum Hadir</div>
                </div>
            </div>
        @else
            {{-- Panitia/Peserta Dashboard --}}
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div class="bg-white rounded-lg shadow-md p-6 text-center">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Total Kegiatan Wajib</h3>
                    <p class="text-3xl font-bold text-red-600">{{ $totalKegiatanWajib }}</p>
                </div>
                <div class="bg-white rounded-lg shadow-md p-6 text-center">
                    <div class="w-16 h-16 bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-800 mb-2">Total Kehadiran Anda</h3>
                    <p class="text-3xl font-bold text-gray-800">{{ $totalKehadiran }}</p>
                </div>
            </div>
        @endif
    </div>
