    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="text-center">
                <div class="w-16 h-16 red-gradient rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 16h4.01M20 12h.01M12 8h4.01M8 16h.01M4 16h.01M4 20h.01M12 20h.01M16 20h.01M20 20h.01M12 16h.01M8 12h.01M4 12h.01M4 8h.01M8 8h.01"></path>
                    </svg>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md card-simple p-6">
            <div class="text-center">
                ...
                <p class="text-gray-600 text-sm mb-4">Tambah, edit, dan kelola data peserta kegiatan</p>
