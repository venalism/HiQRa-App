        ...
        <form action="{{ route('kegiatan.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nama_kegiatan" id="nama_kegiatan" class="input-field" value="{{ old('nama_kegiatan') }}" required>
                    @error('nama_kegiatan')
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" id="tanggal" class="input-field" value="{{ old('tanggal') }}" required>
                     @error('tanggal')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="lokasi" id="lokasi" class="input-field" value="{{ old('lokasi') }}" required>
                     @error('lokasi')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex justify-end items-center mt-8 gap-4">
                ...
                <button type="submit" class="px-6 py-2.5 red-gradient text-white rounded-md font-semibold shadow-lg btn-hover">Simpan Kegiatan</button>
            </div>
        </form>
    </div>
</div>
