                ...
                <table class="min-w-full bg-white">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No. HP</th>
                            <th class="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Prodi</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($peserta as $p)
                            <tr>
                                ...
                                <td class="py-4 px-6 text-sm text-gray-500 whitespace-nowrap">{{ $p->kelas->prodi->nama ?? '-' }}</td>
