                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col"
                                ...
                                HP</th>
                            <th scope="col"
                                class="py-3 px-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kelas
                            </th>
                            <th scope="col"
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-6 text-sm text-center whitespace-nowrap">
                                    <div class="flex justify-center items-center gap-2">
                                        <a href="{{ route('peserta.qr', $p->id) }}"
                                            class="text-green-600 hover:text-green-900" title="Tampilkan QR Code">
                                        ...
                                        <a href="{{ route('peserta.edit', parameters: ['peserta' => $p->id]) }}"
