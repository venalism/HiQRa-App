            ...
            <div class="grid grid-cols-5 grid-rows-5 gap-4">
                ...
                <div
                    ...
                    <div class="p-4 bg-gray-100 rounded-md">
                        <div class="qr-code">
                            {!! QrCode::size(300)->generate($panitia->npm) !!}
                        </div>
                    </div>
                ...
                <div class="col-span-3 row-span-2 col-start-3 row-start-4 bg-white p-6 rounded-lg shadow-md">
                    ...
                    <form method="POST" action="{{ route('panitia.settings.update') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $panitia->nama) }}" required
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        <div class="mb-4">
                            <label for="no_hp" class="block text-gray-700 font-bold mb-2">Nomor HP</label>
                            <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $panitia->no_hp) }}" required
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        </div>
                        <div class="mb-4">
