                    ...
                    <div>
                        ...
                        <select name="prodi" id="prodi" class="input-field">
                            ...
                            @foreach($prodiOptions as $option)
                                <option value="{{ $option }}" {{ old('prodi') == $option ? 'selected' : '' }}>{{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="kelas" id="kelas" class="input-field">
                            ...
                            @foreach($kelasOptions as $option)
                                <option value="{{ $option }}" {{ old('kelas') == $option ? 'selected' : '' }}>{{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select name="tingkat" id="tingkat" class="input-field">
                            ...
                            @foreach($tingkatOptions as $option)
                                <option value="{{ $option }}" {{ old('tingkat') == $option ? 'selected' : '' }}>{{ $option }}</option>
                            @endforeach
                        </select>
                    </div>
