        ...
        <div class="card-body">
            <form action="{{ route('panitia.update', $panitia->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $panitia->nama) }}" class="form-control" required>
                </div>

                {{-- Email --}}
                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" name="email" id="email" value="{{ old('email', $panitia->email) }}" class="form-control" required>
                </div>

                {{-- No HP --}}
                <div class="mb-3">
                    <label for="no_hp" class="form-label">No HP</label>
                    <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp', $panitia->no_hp) }}" class="form-control" required>
                </div>
